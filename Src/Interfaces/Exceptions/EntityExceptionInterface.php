...
/**
 * When an error occurs in the entity operations, this exception is thrown.
 * For example, if the entity is initialized with an invalid value.
 * 
 * @category  EntityExceptionInterface
 * @package   Josevaltersilvacarneiro\Html\Src\Interfaces\Exceptions
 * @author    José Carneiro <git@josevaltersilvacarneiro.net>
 ...
 * @link      https://github.com/josevaltersilvacarneiro/html/tree/main/Src/Interfaces/Exceptions
 */
interface EntityExceptionInterface extends HtmlExceptionInterface
{
