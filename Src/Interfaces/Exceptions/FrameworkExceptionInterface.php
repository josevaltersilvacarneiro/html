...
/**
 * This exception is thrown when occurs an incorrect implementation
 * of the framework. For example, if the EntityManager cannot
 * instantiate a PDO object for a given entity.
 * 
 * @category  FrameworkExceptionInterface
 * @package   Josevaltersilvacarneiro\Html\Src\Interfaces\Exceptions
 * @author    José Carneiro <git@josevaltersilvacarneiro.net>
 ...
 * @link      https://github.com/josevaltersilvacarneiro/html/tree/main/Src/Interfaces/Exceptions
 */
interface FrameworkExceptionInterface extends HtmlExceptionInterface
{
