...
/**
 * This interface represents a date.
 * 
 * It's reccomended that the class that implements it inherits from
 * DateTimeImmutable.
 * 
 * @category  DateAttributeInterface
 * @package   Josevaltersilvacarneiro\Html\Src\Interfaces\Attributes
 * @author    José Carneiro <git@josevaltersilvacarneiro.net>
 ...
 */
interface DateAttributeInterface extends AttributeInterface, \DateTimeInterface
{
