...
/**
 * This class represents a specialized date that extends the built-in
 * \DateTimeImmutable class, which provides immutable date and time.
 * 
 * @category  DateAttribute
 * @package   Josevaltersilvacarneiro\Html\App\Model\Attributes
 * @author    José Carneiro <git@josevaltersilvacarneiro.net>
...
final class DateAttribute extends \DateTimeImmutable implements
    DateAttributeInterface
{
    /**
     * This method returns the representation of this date.
     * 
     * @return mixed Date
     */
     ...
     * 
     * @return DateAttributeInterface|null $this on success, null on failure
     */
    public function newInstance(mixed $value): ?DateAttributeInterface
    {
