...
/**
 * This class represents the controller that renders the page
 * where the user type the email to recover the account.
 * 
 * @category  Recover
 ...
 */
final class Recover extends HTMLController
{
    /**
    ...
    {
        $this->setPage('Recover');
        $this->setTitle('I forgot my password');
        $this->setDescription(
            'Users are required to enter their registered email address to
            initiate the account recovery process.'
        );
        $this->setKeywords('MVC SOLID josevaltersilvacarneiro recover');
    }
