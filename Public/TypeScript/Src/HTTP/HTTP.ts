...
function request(method: string, url: string, params: Object = {}): Promise<Object> {
...
function post(url: string, params: Object): Promise<Object> {
...
function redirect(url: string, params: Map<string, string> = new Map()): void {
